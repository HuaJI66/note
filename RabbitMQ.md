...
AMQP（Advanced Message Queuing Protocol，高级[消息队列](https://so.csdn.net/so/search?q=消息队列&spm=1001.2101.3001.7020)协议）是一个进程间传递**异步消息**的**网络协议**。

## 二、AMQP模型

![在这里插入图片描述](imgs/20181022113306601)
...
![在这里插入图片描述](imgs/20181022123111574)
...
直连型交换机图例：
![在这里插入图片描述](imgs/20181022130416336)
...
扇型交换机图例：
![在这里插入图片描述](imgs/20181022130646170)
...
主题交换机图例：
![在这里插入图片描述](imgs/20181022131252616)
